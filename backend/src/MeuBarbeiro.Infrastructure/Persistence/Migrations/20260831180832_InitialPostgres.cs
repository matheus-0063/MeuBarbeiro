...
namespace MeuBarbeiro.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialPostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AppointmentServiceSelections",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentServiceSelections", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    OwnerUserId = table.Column<Guid>(type: "uuid", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "EventProcessingAudits",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    EventName = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    QueueName = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventProcessingAudits", x => x.Id);
                });
